...
async function main() {
  ...
  // Create Affiliate Links for equipment - using Amazon search URLs for better product discovery
  const affiliateLinks = await Promise.all([
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: paddles[0].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=JOOLA+Ben+Johns+Hyperion+CFS+16+Pickleball+Paddle&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        ...
        url: "https://www.justpaddles.com/products/pickleball-paddles?search=joola+ben+johns+hyperion",
        priority: 2,
        commission: 0.07,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: paddles[1].id,
        retailer: "selkirk",
        url: "https://www.selkirk.com/collections/paddles?q=luxx+control+air",
        priority: 3,
        commission: 0.15,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: paddles[1].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=Selkirk+LUXX+Control+Air+Pickleball+Paddle&tag=pickleballgear-20",
        priority: 2,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        ...
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=Franklin+Ben+Johns+Signature+Pickleball+Paddle&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: paddles[3].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=Paddletek+Bantam+EX-L+Pro+Pickleball+Paddle&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: paddles[4].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=Engage+Pursuit+Pro+MX+Pickleball+Paddle&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: shoes[0].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=K-Swiss+Hypercourt+Express+2+Tennis+Shoes&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: shoes[1].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=ASICS+Gel+Rocket+11+Court+Shoes&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: shoes[2].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=Nike+Court+Air+Zoom+Vapor+Pro+2+Tennis+Shoes&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
    ...
    prisma.affiliateLink.create({
      data: {
        equipmentId: shoes[3].id,
        retailer: "amazon",
        url: "https://www.amazon.com/s?k=New+Balance+Fresh+Foam+LAV+v2+Tennis+Shoes&tag=pickleballgear-20",
        priority: 1,
        commission: 0.03,
        isActive: true,
      },
